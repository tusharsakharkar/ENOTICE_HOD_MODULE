...
}]).controller('otherdepartmentCtrl', ['$scope', '$timeout', '$firebaseArray', 'CommonProp', '$firebaseObject', '$firebaseAuth', function ($scope, $timeout, $firebaseArray, CommonProp, $firebaseObject, $firebaseAuth) {
    $scope.loading = false;
    $("#prog").hide();
    var ref;
